# Generated by Django 2.1.5 on 2019-02-08 05:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inputType', models.CharField(default='text', max_length=10)),
                ('keywords', models.TextField(blank=True, max_length=200)),
                ('totalScenarios', models.IntegerField(blank=True, default=0, null=True)),
            ],
            options={
                'ordering': ('request_id',),
            },
